...
require_once(dirname(__FILE__) . '/traits/tcpdf_write_html.php');
require_once(dirname(__FILE__) . '/traits/tcpdf_write.php');
require_once(dirname(__FILE__) . '/traits/tcpdf_multi_cell.php');
require_once(dirname(__FILE__) . '/traits/tcpdf_cell.php');
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
class TCPDF
{
	...
	use TCPDF_WRITE_HTML;
	use TCPDF_WRITE;
	use TCPDF_MULTI_CELL;
	use TCPDF_CELL;
